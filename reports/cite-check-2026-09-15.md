# 引文完整性核验台账 — 2026-09-15

> 模式：flag 仅提示（非阻断） · 生成时间：2026-09-15T08:00:53.292Z
...
| ↪ 重定向（redirect） | 0 |
| ❌ 死链（dead, 404/410） | 5 |
| 🚫 出版商拦截（blocked, 401/403/429/451） | 22 |
| ❓ 索引查无（unresolved） | 0 |
| 🔧 上游故障（server-error, 5xx） | 0 |
| ⚠ 本次不可达（unreachable） | 14 |
| 🔴 已撤回（retracted） | 0 |
| 引用逐条核验 | 1/19 verified · 15 mismatch · 3 unverified |

## ❌ 需处理：死链 / 已撤回

| 文件 | 类型 | 目标 | 状态 | HTTP | 备注 |
|---|---|---|---|---|---|
| `content\blog\geo-roundup-2026-08-05.md` | url | https://doi.org/10.6028/nist.ir.8605d | **dead** | 404 |  |
| `content\blog\geo-roundup-2026-08-05.md` | url | https://doi.org/10.37473/dac/10.1101/2020.05.04.075747 | **dead** | 404 |  |
| `docs\competition-2026\TECH-DEEP-DIVE.md` | url | https://dev.to/lcmd007/...one-click-rollback | **dead** | 404 |  |
| `docs\competition-2026\TECH-DEEP-DIVE.md` | url | https://developer.hpe.com/blog/llm-agentic-tool-mesh | **dead** | 404 |  |
| `content\blog\geo-roundup-2026-08-05.md` | doi | 10.37473/dac/10.1101/2020.05.04.075747 | **dead** | 404 | json-parse-failed |
...
共 22 条。多为出版商对 bot 返回 401/403/429/451（如 ScienceDirect、Wiley、Hindawi 对自动化请求恒 403），

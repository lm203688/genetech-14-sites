...
> 模式：**STRICT 硬门禁** · 生成时间：2026-09-16T00:16:06.752Z
...
| ↪ 重定向（redirect） | 0 |
| ❌ 死链（dead, 404/410） | 0 |
| 🚫 出版商拦截（blocked, 401/403/429/451） | 32 |
| ❓ 索引查无（unresolved） | 0 |
| 🔧 上游故障（server-error, 5xx） | 0 |
| ⚠ 本次不可达（unreachable） | 25 |
| 🔴 已撤回（retracted） | 0 |
...
共 25 条，多为网络受限或目标超时，**不判定为死链**；下次运行会重试。

## 🚫 出版商/反爬拦截（blocked，非死链，不需处理）

共 32 条。多为出版商对 bot 返回 401/403/429/451（如 ScienceDirect、Wiley、Hindawi 对自动化请求恒 403），
